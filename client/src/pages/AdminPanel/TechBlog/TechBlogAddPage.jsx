...
export default function TechBlogEditPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-10">
            <h2 className="text-3xl font-bold text-stone-800 mb-2">Article Creator</h2>
            ...
            >
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        type="text"
                        name="author" // Matches the key in formData
                        id="author"
                        value={formData.author} // Binds to formData.student_name
                        onChange={handleChange}
                        required
                        className="px-4 py-2 border border-stone-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-300"
                    />
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        type="url"
                        name="link" // Matches the key in formData
                        id="link"
                        value={formData.link} // Binds to formData.project_link
                        onChange={handleChange}
                        required
